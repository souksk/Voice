    ...
    return (
      <View>
        ...
        <View style={{width:'100%',borderBottomWidth:1,borderBottomColor:'#5E8D48'}}>
          <Text style={styles.head}>GIOI THIEU PAGE</Text>
        </View>
        <SafeAreaView  style={{alignContent:"center",alignSelf:'center',alignItems:"center"}}>
          <Text style={{alignContent:"center",alignSelf:'center',alignItems:"center",paddingTop:50,fontSize:40}}> đây là giới thiệu </Text>
        </SafeAreaView>
      </View>
    );
  }
